...
pub enum PulserError {
    ...
    WebhookError(String),
    #[error("{0}")]
    WithContext(Box<types::ContextualError>),
}
...
impl PulserError {
    pub fn add_context(self, context: ErrorContext) -> Self {
        match self {
            ...
            _ => Self::WithContext(Box::new(types::ContextualError {
                error: self,
                context,
            }))
        }
    ...
    pub fn category(&self) -> types::ErrorCategory {
        match self {
            ...
            Self::ConfigError(_) => types::ErrorCategory::Configuration,
            Self::NetworkError(_) => types::ErrorCategory::Network,
            Self::ApiError(_) => types::ErrorCategory::External,
            Self::UserNotFound(_) => types::ErrorCategory::NotFound,
            Self::TransactionError(_) => types::ErrorCategory::Bitcoin,
            Self::WalletError(_) => types::ErrorCategory::Bitcoin,
            Self::AuthError(_) => types::ErrorCategory::Authentication,
            Self::InternalError(_) => types::ErrorCategory::Internal,
            Self::InvalidRequest(_) => types::ErrorCategory::Validation,
            Self::InsufficientFunds(_) => types::ErrorCategory::Bitcoin,
            Self::PriceFeedError(_) => types::ErrorCategory::PriceFeed,
            Self::StorageError(_) => types::ErrorCategory::Storage,
            Self::PsbtError(_) => types::ErrorCategory::Bitcoin,
            Self::SigningError(_) => types::ErrorCategory::Bitcoin,
            Self::BroadcastError(_) => types::ErrorCategory::Network,
            Self::ChannelError(_) => types::ErrorCategory::Network,
            Self::TaprootError(_) => types::ErrorCategory::Bitcoin,
            Self::InvalidInput(_) => types::ErrorCategory::Validation,
            Self::BitcoinError(_) => types::ErrorCategory::Bitcoin,
            Self::ConsensusError(_) => types::ErrorCategory::Bitcoin,
            Self::WebhookError(_) => types::ErrorCategory::External,
        }
    }

    pub fn is_retryable(&self) -> bool {
        match self.category() {
            types::ErrorCategory::Network |
            types::ErrorCategory::External |
            types::ErrorCategory::PriceFeed => true,
            _ => false
        }
    }
}
