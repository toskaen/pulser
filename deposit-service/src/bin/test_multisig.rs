// deposit-service/examples/test_multisig_deposit.rs
...
EsploraClient::from_url("https://blockstream.info/testnet/api/")
    ...
    // Test keys - you can generate these using bitcoin-cli or another tool
    ...
    info!("Creating multisig wallet with keys:");
        ...
        if utxos.is_empty() {
            ...
            for (i, utxo) in utxos.iter().enumerate() {
                info!("UTXO #{}: {} sats, confirmations: {}", 
                     i+1, utxo.value, utxo.confirmations);
